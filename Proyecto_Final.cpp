// El siguiente Código se fundamente en la experiencia del ING. CARLOS ALDAIR ROMAN BALBUENA Y EL ING. Arturo Pérez De la Cruz
//Y la implemtanción de los ALUMNOS: 
//PROYECTO FINAL CG
...
int main()
{
	...
	Shader SkyBoxshader("Shaders/SkyBox.vs", "Shaders/SkyBox.frag");//para la caja
	...
	Model CabanaLeslie((char*)"Models/Carro/log cabin.obj");
	Model CabanaGrande((char*)"Models/Carro/Hut_obj.obj");
	Model MesitaNche((char*)"Models/Carro/nighttable.obj");
	Model NuevaCama((char*)"Models/Carro/Full_Size_Bed_with_White_Sheets_Black_V1.obj");
	Model LapmNight((char*)"Models/Carro/sconce_01.obj");
	...
	GLfloat skyboxVertices[] = {   //para la caja
		// Positions
		-1.0f,  1.0f, -1.0f,
		-1.0f, -1.0f, -1.0f,
		1.0f, -1.0f, -1.0f,
	...
	faces.push_back("SkyBox/top_.tga");
	faces.push_back("SkyBox/bottom_.tga");
	//faces.push_back("SkyBox/back.tga");
	faces.push_back("SkyBox/prueba.tga");
	//faces.push_back("SkyBox/prueba_2.tga");
	faces.push_back("SkyBox/front_.tga");
	//faces.push_back("SkyBox/prueba.tga");
	

	GLuint cubemapTexture = TextureLoading::LoadCubemap(faces);//PARA LA CAJA
	...
	//Posibbleeeeeeeeeeeeeeeeeeee error
//	//PARA LA CAJA
//// Load textures
//	vector<const GLchar*> faces;
...
//
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Point light 1
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[0].position"), pointLightPositions[199].x, pointLightPositions[199].y, pointLightPositions[199].z);
...
/////////////////////////////////////////////Modelo sin animación/////////////////////////////////////////////////////////
		...
		model = glm::mat4(1);
		//model = glm::translate(model, PosIni + glm::vec3(movKitX, 0, movKitZ));
		model = glm::translate(model, glm::vec3(-56.0f, 0.0f, 35.0f));;///-56se pasa,//bien,//
		model = glm::rotate(model, glm::radians(rotKit), glm::vec3(0.0f, 0.0f, 90.0f));
		model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));

		CabanaLeslie.Draw(lightingShader);
		glBindVertexArray(0);
	   ...
	   //Refrigerador 
		...
		model = glm::mat4(1);
		//model = glm::translate(model, PosIni + glm::vec3(movKitX, 0, movKitZ));
		model = glm::translate(model, glm::vec3(-26.0f, 0.0f, -38.5f));
		model = glm::rotate(model, glm::radians(rotKit), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.09f, 0.09f, 0.09f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));

		CabanaGrande.Draw(lightingShader);
		...
		model = glm::mat4(1);
		//model = glm::translate(model, PosIni + glm::vec3(movKitX, 0, movKitZ));
		model = glm::translate(model, glm::vec3(-23.0f, 0.0f, -41.5f));
		model = glm::rotate(model, glm::radians(rotKit), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.9f, 0.9f, 0.9f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		MesitaNche.Draw(lightingShader);
		...
		model = glm::mat4(1);
		//model = glm::translate(model, PosIni + glm::vec3(movKitX, 0, movKitZ));
		model = glm::translate(model, glm::vec3(-23.0f, 1.2f, -41.5f));
		model = glm::rotate(model, glm::radians(rotKit), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.9f, 0.9f, 0.9f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		LapmNight.Draw(lightingShader);
		...
		model = glm::mat4(1);
		//model = glm::translate(model, PosIni + glm::vec3(movKitX, 0, movKitZ));
		model = glm::translate(model, glm::vec3(-25.6f, 0.0f, -39.9f));
		model = glm::rotate(model, glm::radians(rotKit), glm::vec3(0.0f, 1.0f, 0.0));
		model = glm::scale(model, glm::vec3(0.02f, 0.02f, 0.02f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		NuevaCama.Draw(lightingShader);
	...
	glDeleteVertexArrays(1, &skyboxVAO);//PARA  LA CAJA
	glDeleteBuffers(1, &skyboxVBO);//PARA  LA CAJA
...
void KeyCallback(GLFWwindow *window, int key, int scancode, int action, int mode)
{
	...
	if (keys[GLFW_KEY_SPACE])
	{
		active = !active;
		if (active)
			LightP1 = glm::vec3(1.0f, 20.0f, 0.0f);///original(1.0f, 0.0f, 0.0f)
		else
